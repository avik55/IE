        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                if (user.EmailConfirmed == true)
                {
                    ...
                    //    ModelState.AddModelError("", "Your Account is Not approved. Plz Contact Admin.");
                    //    ViewBag.msg = " Your Account is Not approved. Plz Contact Admin.";
                    //    return View(model);
                    //}
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        ViewBag.UserId = user.Id;
                        var message = "Confirmation Mail send on Your EmailId. Please confirm Email.";
                        return Json(message, JsonRequestBehavior.AllowGet);
